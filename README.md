...
- ♻️ **跨帖子图片去重**：除来源 ID 去重外，还会为 Pixiv / X / 抖音图片建立持久感知指纹；同一平台的同一帖子内所有图片一律视为差分内容，不互相判重或判相似；只有跨平台帖子，或同平台的不同帖子之间才比较。结构与低频颜色都严格一致时才自动去重，整图近似或“完整原图被拆成二/三分栏、2×2、3×3 局部图”的候选都不会自动删除，而是在审批卡片标出类型、双方来源、分辨率和文件大小
